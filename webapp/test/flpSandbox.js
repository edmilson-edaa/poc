					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Dynamic Tooltips Test",
									"targetURL": "#eincodespoc-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"eincodespoc-display": {
								"semanticObject": "eincodespoc",
								"action": "display",
								"description": "Dynamic Tooltips Test",
								"title": "Dynamic Tooltips Test",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ein.codes.poc",
									"url": sap.ui.require.toUrl("ein/codes/poc")
								}
							}
						}
					}
